...
const getRolePrice = (basePrice: number) => {
    ...
    switch (currentUser.value.role) {
        case 'Technician': return basePrice * 0.96;
        case 'Dealer':     return basePrice * 0.95;
        case 'Franchise':  return basePrice * 0.94;
                    ...
                    <table class="w-full text-left border-separate border-spacing-0 table-auto">
                        <thead class="bg-slate-50 sticky top-0 z-30">
                            <tr class="text-[12px] uppercase tracking-tighter text-slate-500 font-black">
                                ...
                                <th class="p-3 w-20 bg-emerald-50 text-center text-emerald-700 border-b border-r border-slate-200">6 ชิ้นขึ้นไป</th>
                        ...
                        <tbody class="text-[12px] bg-white">
                            <tr v-for="product in products" :key="product.id" class="hover:bg-slate-50 transition-colors group">
                                ...
                                <td class="p-3 min-w-50 max-w-62.5 border-b border-r border-slate-100 whitespace-normal text-slate-500 italic">
                                    {{ product.specs }}
                                </td>
                                ...
                                <td class="p-3 text-center font-bold bg-slate-50/50 border-b border-r border-slate-100">
