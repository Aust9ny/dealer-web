...
<template>
  ...
  >
    ...
    <div class="flex items-center gap-3 ml-auto lg:hidden">
      ...
      <div
        v-if="showSearchModal"
        class="fixed top-0 left-0 right-0 h-16 bg-white flex items-center px-4 lg:hidden z-150"
      >
    ...
    <div class="hidden lg:flex flex-1 justify-center px-12 relative">
    ...
    <div class="hidden lg:flex items-center gap-4">
      ...
      <div ref="desktopDropdownRef" class="relative">
        ...
        >
          <div
            class="w-8 h-8 rounded-full bg-[#003E73] flex items-center justify-center text-white text-sm font-black border border-white/20"
          >
            {{ initials }}
          </div>
  ...
  <transition name="slide-left">
    <div
      v-if="isSidebarOpen"
      class="fixed top-0 left-0 h-full w-80 bg-white z-150 shadow-xl lg:hidden flex flex-col"
    >
